...
class Philanthropy_Project {
    ...
    public function register_scripts(){
        ...
        wp_register_style( 'pp-autocomplete-css', $this->directory_url.'assets/css/styles.css', false, '1.0' );
        ...
        wp_register_script( 'pp-mockjax', $this->directory_url . 'assets/js/jquery.mockjax.js', array('jquery', ), $this->version, true );
        wp_register_script( 'pp-autocomplete', $this->directory_url . 'assets/js/jquery.autocomplete.js', array('jquery', ), $this->version, true );
        wp_register_script( 'pp-autocomplete-custom', $this->directory_url . 'assets/js/autocomplete-custom.js', array('jquery', ), $this->version, true );
    ...
    public function enqueue_scripts() {
        ...
        if ( charitable_is_page( 'campaign_submission_page' ) ) {
            ...
            wp_enqueue_script( 'pp-mockjax' );
            wp_enqueue_script( 'pp-autocomplete' );
            wp_enqueue_script( 'pp-autocomplete-custom' );
            wp_enqueue_script( 'charitable-script' );
            wp_enqueue_script( 'charitable-plup-fields' );
            wp_enqueue_style( 'pp-autocomplete-css' );
