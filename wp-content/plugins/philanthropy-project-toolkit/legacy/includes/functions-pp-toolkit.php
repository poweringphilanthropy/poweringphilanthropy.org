...
function pp_edd_checkout_form() {
    ...
    ob_start();
        ...
        if ( edd_get_cart_contents() || edd_cart_has_fees() ) :
            ...
            edd_checkout_cart();
        ?>
            <div id="edd_checkout_form_wrap" class="edd_clearfix col-lg-10 form-block">
                <?php do_action( 'edd_before_purchase_form' ); ?>
                <form id="edd_purchase_form" class="edd_form form-inline checkout-form" action="<?php echo $form_action; ?>" method="POST" enctype="multipart/form-data">
                    <?php
                    /**
