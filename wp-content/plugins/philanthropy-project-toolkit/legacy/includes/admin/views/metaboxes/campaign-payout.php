...
$einnumber = get_post_meta( $post->ID, 'charitable_ein_number', true );
...
<div class="charitable-metabox wrapper-hide-show">
			...
			<tr>
				...
				<td>
					<select name="_campaign_payout_options" class="hide-show-trigger">
						...
						<option value="direct" <?php selected($payout_option, 'direct'); ?>><?php _e('Registered non profit', 'pp-toolkit'); ?></option>
						<option value="non-direct" <?php selected($payout_option, ''); ?>><?php _e('Unregistered non profit', 'pp-toolkit'); ?></option>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input name="_campaign_platform_fee" type="number" min="0" max="100" step=".01" value="<?php echo $platform_fee; ?>">
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table class="widefat">
		<tbody>
			...
			<tr class="hide-show show-if-check show-if-direct">
				<th><?php _e('Ein Number:', 'pp-toolkit'); ?></th>
				<td><input type="text" id="charitable_ein_number" name="charitable_ein_number" value="<?php echo $einnumber; ?>" ></td>
			</tr>
